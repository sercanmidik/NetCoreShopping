        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeatureContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BannerTitleOne = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BannerTitleTwo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BannerContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "DealsOfTheWeeks",
                columns: table => new
                {
                    DealsOfTheWeekId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DealsOfTheWeeks", x => x.DealsOfTheWeekId);
                    table.ForeignKey(
                        name: "FK_DealsOfTheWeeks_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HalfStarCount = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DealsOfTheWeeks_ProductId",
                table: "DealsOfTheWeeks",
                column: "ProductId",
                unique: true);
